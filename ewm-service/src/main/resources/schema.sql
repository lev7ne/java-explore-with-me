...
(
    ...
    mutual_subscription BOOLEAN                                 NOT NULL,
    CONSTRAINT pk_subscriptions PRIMARY KEY (id),
    CONSTRAINT fk_subscriptions_user_to_users FOREIGN KEY (user_id) REFERENCES users (id),
    CONSTRAINT fk_subscriptions_subscriber_to_users FOREIGN KEY (subscribed_user_id) REFERENCES users (id),
    CONSTRAINT unique_pair_user_id_subscriber_id UNIQUE (user_id, subscribed_user_id)
);
